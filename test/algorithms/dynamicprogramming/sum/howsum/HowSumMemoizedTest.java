...
class HowSumMemoizedTest {

    @Test
    void shouldReturnNumbersWhenThereIsACombinationOfNumbersThatSumToN() {
        List<Integer> result = HowSumMemoized.forNumber(7, List.of(2, 4, 1, 8));
    ...
    void shouldReturnNullWhenThereIsNoCombinationOfNumbersThatSumToN() {
        List<Integer> result = HowSumMemoized.forNumber(7, List.of(3, 5, 6));
    ...
    void shouldNotTakeALongTimeEvenWhenNIsABigNumber() {
        List<Integer> result = HowSumMemoized.forNumber(500, List.of(3, 6));
